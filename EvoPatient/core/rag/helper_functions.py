...
def _make_embeddings():
    """Create BailianEmbeddings (raw client, avoids langchain-openai format incompatibility)."""
...
def replace_t_with_space_for_text(list_of_text):
    """
    Replaces all tab characters ('\t') with spaces in the page content of each document.
    ...
    new_list = [s.replace('\t', ' ') for s in list_of_text]
    return new_list
